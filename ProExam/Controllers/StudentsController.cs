...
namespace ProExam.Controllers
{
    public class StudentsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentCode,Stu_FirstName,Stu_LastName,Stu_DOB,Stu_Gender,Stu_Email,Stu_PhoneNumber,Stu_Address,Stu_Password")] Student student)
        {
            if (ModelState.IsValid)
            {
